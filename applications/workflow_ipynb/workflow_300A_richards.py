...
temp_app_dir = "/global/cscratch1/sd/peishi89/DART_PFLOTRAN_APP/applications/template"          # The template for application folder
app_dir      = "/global/project/projectdirs/m1800/peishi/300A_analysis/Richards_av_std1.5"          # The template for application folder
...
# para_prior_rescaled_set = [False, False]  # Whether the prior is generated by rescaling the posterior
...
da_cfg["assim_window_seconds"] = 12*3600  # assimilation time window/step  (second)
...
if da_cfg["assim_window_fixed"]:
    ...
    time_cfg["last_obs_time_seconds"] = time_cfg["first_obs_time_seconds"] + 3*da_cfg["assim_window_seconds"]
