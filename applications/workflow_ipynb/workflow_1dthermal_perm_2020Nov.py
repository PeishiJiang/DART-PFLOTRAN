...
para_sample_method_set = ["lognormal"]  # the parameter sampling method, including: SGS, US, SIS, rescale, normal, lognormal, truncated_normal, uniform
...
# Others
para_take_log_set = [True] # Indicate whether the parameters should be estimated based on its original value or log value
...
da_cfg["assim_window_list"] = [2., (5*50*60+10)/86400.] # day
...
script_file   = 'workflow_1dthermal_perm_2020Nov'
