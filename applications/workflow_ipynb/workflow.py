...
app_dir      = "/Users/jian449/Codes/DART/manhattan/models/pflotran/applications/1dthermal_1var_enksmda"          # The application folder name
...
subprocess.run("cd {}; rm *".format(pflotran_out_dir), shell=True, check=False)
subprocess.run("cd {}; rm *".format(dart_inout_dir), shell=True, check=False)
...
time_cfg["last_obs_time_seconds"] = 3600*10
...
#%% [markdown]
#  ****************
#  **Config the EnKS-MDA settings**

#%%
# The inflation settings used in EnKS-MDA (the alpha value)
da_cfg["enks_mda_alpha"] = [10., 10., 10., 10., 10., 10., 10., 10., 10., 10.]  # Note that the summation of the inverse of alpha should be one
