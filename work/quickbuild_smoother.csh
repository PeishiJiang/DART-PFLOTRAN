...
#----------------------------------------------------------------------
# to enable an MPI parallel version of smoother for this model,
...
echo
echo "---------------------------------------------------"
echo "build number $n is mkmf_smoother"
csh   mkmf_smoother -mpi
make

mv smoother ${app_work_dir} || exit 6
...
#echo
#echo 'time to run smoother here:'
#echo ' for lsf run "bsub < runme_smoother"'
#echo ' for pbs run "qsub runme_smoother"'
#echo ' for lam-mpi run "lamboot" once, then "runme_smoother"'
#echo ' for mpich run "mpd" once, then "runme_smoother"'
