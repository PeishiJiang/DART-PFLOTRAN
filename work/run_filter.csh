...
# ====================================================================
# Added by Peishi
# This script is used for conducting data assimilation on the PFLOTRAN
# model. The following files are required to be prepared beforehand:
# * observation data in DART format
# * input.nml
# * DART generic variable quantity files
# * PFLOTRAN.in
# * PFLOTRAN parameters (parameters.h5)
# ====================================================================
#
...
#TODO If you run the script in a queuing system, consider if-else option
...
# $URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/template/shell_scripts/run_filter.csh $
# $Revision: 10982 $
# $Date: 2017-02-01 15:43:10 -0800 (Wed, 01 Feb 2017) $
