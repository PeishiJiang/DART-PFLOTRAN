...
!
! $Id: obs_utilities_mod.f90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/observations/obs_converters/utilities/obs_utilities_mod.f90 $"
