...
!
! DART $Id: model_check_utilities_mod.f90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
...
character(len=*), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/model_mod_tools/model_check_utilities_mod.f90 $"
...
integer               , intent(in)    :: obs_time_seconds
integer               , intent(in)    :: obs_time_days
...
obs_time = set_time(obs_time_seconds, obs_time_days)
...
call model_interpolate(ens_handle, ens_size, location, obs_time, quantity_index, interp_vals, ios_out)
...
! $URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/model_mod_tools/model_check_utilities_mod.f90 $
! $Id: model_check_utilities_mod.f90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
! $Revision: 13137 $
