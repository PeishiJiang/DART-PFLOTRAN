...
!
! $Id: test_interpolate_threed_cartesian.f90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/models/model_mod_tools/test_interpolate_threed_cartesian.f90 $"
...
do i = 1, nx
   ...
   do j = 1, ny
      ...
      do k = 1, nz
         ...
         call model_interpolate(ens_handle, ens_size, loc, obs_time, quantity_index, &
                                field(i,j,k,:), ios_out)
