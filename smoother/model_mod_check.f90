...
!
! $Id: model_mod_check.f90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
...
use      time_manager_mod, only : time_type, get_time, print_time, print_date, operator(-), &
...
use             model_mod, only : get_model_size, get_state_meta_data, end_model
...
character(len=256), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/assimilation_code/programs/model_mod_check/model_mod_check.f90 $"
...
integer                   :: obs_time_seconds = -1.0_r8
integer                   :: obs_time_days =-1.0_r8
...
namelist /model_mod_check_nml/ x_ind, num_ens,                             &
                               ...
                               obs_time_seconds,   obs_time_days,          &
...
call get_state_meta_data(iloc, loc, var_type, time)
...
write(string1,'("index ",i11," is i,j,k ",3(1x,i4), " at time ", i8, " and is in domain ",i2)') &
                  iloc, ix, iy, iz, sec, dom_id
...
do imem = 1, num_ens
   ...
   ! print *, my_base
   ! print *, my_desc
   ! print *, imem, my_base, file_array_output(imem,:), my_desc
