...
integer, parameter, public :: &
  ...
  QTY_PFLOTRAN_THERMAL_CONDUCTIVITY  = 372, &
  QTY_PFLOTRAN_FLOW_FLUX  = 373
...
obs_kind_names(372) = obs_kind_type(QTY_PFLOTRAN_THERMAL_CONDUCTIVITY, 'QTY_PFLOTRAN_THERMAL_CONDUCTIVITY')
obs_kind_names(373) = obs_kind_type(QTY_PFLOTRAN_FLOW_FLUX, 'QTY_PFLOTRAN_FLOW_FLUX')
