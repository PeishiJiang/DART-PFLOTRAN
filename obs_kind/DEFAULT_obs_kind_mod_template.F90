...
integer, parameter :: max_defined_quantities = 369
...
! PFLOTRAN
obs_kind_names(367) = obs_kind_type(QTY_LIQUID_SATURATION,    'QTY_LIQUID_SATURATION')
obs_kind_names(368) = obs_kind_type(QTY_LIQUID_PRESSURE,    'QTY_LIQUID_PRESSURE')
obs_kind_names(369) = obs_kind_type(QTY_PERMEABILITY, 'QTY_PERMEABILITY')
