...
!
! $Id: DEFAULT_obs_kind_mod.F90 13137 2019-04-30 15:48:00Z nancy@ucar.edu $
...
integer, parameter, public :: &
  QTY_PFLOTRAN_TEMPERATURE  = 367, &
  QTY_PFLOTRAN_PERMEABILITY  = 368, &
...
integer, parameter, public :: max_defined_types_of_obs =     4
...
character(len=*), parameter :: source   = &
   "$URL: https://svn-dares-dart.cgd.ucar.edu/DART/releases/Manhattan/assimilation_code/modules/observations/DEFAULT_obs_kind_mod.F90 $"
...
obs_type_info(    1) = obs_type_type(LIQUID_SATURATION, &
    'LIQUID_SATURATION', QTY_LIQUID_SATURATION, .false., .false., .false.)
obs_type_info(    2) = obs_type_type(LIQUID_PRESSURE, &
    'LIQUID_PRESSURE', QTY_LIQUID_PRESSURE, .false., .false., .false.)
obs_type_info(    3) = obs_type_type(TEMPERATURE, &
    'TEMPERATURE', QTY_TEMPERATURE, .false., .false., .false.)
obs_type_info(    4) = obs_type_type(PERMEABILITY, &
    'PERMEABILITY', QTY_PERMEABILITY, .false., .false., .false.)
...
! PFLOTRAN -- Added by Peishi
obs_kind_names(367) = obs_kind_type(QTY_PFLOTRAN_TEMPERATURE, 'QTY_PFLOTRAN_TEMPERATURE')
obs_kind_names(368) = obs_kind_type(QTY_PFLOTRAN_PERMEABILITY, 'QTY_PFLOTRAN_PERMEABILITY')
obs_kind_names(369) = obs_kind_type(QTY_PFLOTRAN_POROSITY, 'QTY_PFLOTRAN_POROSITY')
obs_kind_names(370) = obs_kind_type(QTY_PFLOTRAN_THERMALCONDUCTIVITY, 'QTY_PFLOTRAN_THERMALCONDUCTIVITY')
