...
class DaResults(object):
    ...
    def compare_univar_spatial_average(self, var_name, true_file_name, axes, 
                                       plot_time_offset=0, constrained_layout=True, ylim=None):
        ...
        for j in range(nens):
            ...
            line1, = ax1.plot(model_time_list[plot_time_offset:],
                                prior_ens[plot_time_offset:],
                                color='grey',
                                linewidth=0.5,
                                linestyle=':',
                                label='ensemble')
        prior_mean = np.mean(analyzed_prior_ens, axis=(0))
        line2, = ax1.plot(model_time_list[plot_time_offset:],
                            prior_mean[plot_time_offset:],
                            color='red',
                            linewidth=1,
                            label='mean')
        line3, = ax1.plot(true_set_time_used[plot_time_offset:],
                            true_set_used[plot_time_offset:],
                            color='black',
                            linewidth=1,
                            label='obs')
        ...
        for j in range(nens):
            ...
            line1, = ax2.plot(model_time_list[plot_time_offset:],
                                posterior_ens[plot_time_offset:],
                                color='grey',
                                linewidth=0.5,
                                linestyle=':',
                                label='ensemble')
        posterior_mean = np.mean(analyzed_posterior_ens, axis=(0))
        line2, = ax2.plot(model_time_list[plot_time_offset:],
                            posterior_mean[plot_time_offset:],
                            color='red',
                            linewidth=1,
                            label='mean')
        line3, = ax2.plot(true_set_time_used[plot_time_offset:],
                            true_set_used[plot_time_offset:],
                            color='black',
                            linewidth=1,
                            label='obs')
